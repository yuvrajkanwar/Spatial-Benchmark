...
public class Couchbase2Client extends GeoDB {
  ...
  private Status geoInsertKv(ParameterGenerator gen) {
  ...
  private Status geoInsertN1ql(ParameterGenerator gen)
      throws Exception {
  ...
  private Status geoUpdateKv(ParameterGenerator gen)  {
  ...
  private Status geoUpdateN1ql(ParameterGenerator gen)
      throws Exception {
